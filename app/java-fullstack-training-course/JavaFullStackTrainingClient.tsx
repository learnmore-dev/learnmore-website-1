...
interface JavaFullStackTrainingClientProps {
  location?: {
    slug: string;
    name: string;
    address?: string;
...
export default function JavaFullStackTrainingClient({ location }: JavaFullStackTrainingClientProps = {}) {
    ...
    try {
      const res = await fetch('/api/enroll', {
        ...
        body: JSON.stringify({
          ...
          program: 'Java Full Stack Master Program',
  ...
  const javaFullstackTools = [
    { name: 'Spring Boot 3', icon: 'fas fa-leaf', desc: 'Enterprise Java Microservices' },
    { name: 'React.js', icon: 'fab fa-react', desc: 'Frontend Web Application UI' },
    { name: 'Hibernate ORM', icon: 'fas fa-database', desc: 'Database Mapping & JPA' },
    { name: 'Spring Security', icon: 'fas fa-shield-alt', desc: 'JWT Authentication & OAuth' },
    { name: 'MySQL / PostgreSQL', icon: 'fas fa-server', desc: 'Relational Database Engine' },
    { name: 'Docker Containers', icon: 'fab fa-docker', desc: 'Containerized Deployment' },
    { name: 'Maven Build', icon: 'fas fa-box', desc: 'Build Automation Tool' },
    { name: 'AWS EC2 / RDS', icon: 'fab fa-aws', desc: 'Cloud Infrastructure Hosting' }
  ];
  ...
  const syllabusModules = [
    {
      ...
      topics: [
        'HTML5 Semantic Structure & Modern Forms',
        'CSS3 Flexbox, Grid, Custom Properties & Responsive UI',
        'JavaScript ES6+: Promises, Async/Await, Fetch API & DOM',
        'Bootstrap 5 & Tailwind CSS Frameworks'
      ]
    },
    {
      title: 'Module 2: Frontend Engineering with React.js',
      topics: [
        'React Architecture, JSX, Functional Components & Props',
        'React Hooks: useState, useEffect, useMemo, useCallback',
        'Global State Management with Context API & Redux Toolkit',
        'Live Project: Responsive Single-Page Application (SPA)'
      ]
    },
    {
      title: 'Module 3: Core & Advanced Java Programming',
      topics: [
        'Java Fundamentals, Data Types & Control Structures',
        'Object-Oriented Programming (OOPs): Inheritance, Polymorphism & Abstraction',
        'Java Collections Framework (List, Set, Map) & Stream API (Java 8+)',
        'Multithreading, Exception Handling & File I/O'
      ]
    },
    {
      title: 'Module 4: Spring Framework, Spring Boot 3 & Hibernate ORM',
      topics: [
        'Spring Core, Dependency Injection (DI) & Inversion of Control (IoC)',
        'Spring Boot 3 Setup, Auto-Configuration, Spring Data JPA & Hibernate ORM',
        'Building RESTful Web APIs with Spring Boot MVC',
        'Spring Security, JWT Token Authentication & Role-Based Authorization'
      ]
    },
    {
      title: 'Module 5: Microservices Architecture & Database Management',
      topics: [
        'Microservices Design Patterns: Eureka Service Discovery & API Gateway',
        'Inter-Service Communication: Feign Client & RestTemplate',
        'Relational Databases: MySQL & PostgreSQL Queries, JOINs, Indexes & Spring Data JPA Integration',
        'NoSQL Databases: MongoDB Schema Design & Integration'
      ]
    },
    {
      ...
      topics: [
        ...
        'Dockerizing Spring Boot & React Microservices with Docker Compose',
        'Cloud Deployment on AWS EC2 & RDS Database',
        'Capstone Project: Full-Stack Microservices Banking / E-Commerce Platform'
      ]
    }
  ];
  ...
  const capstoneProjects = [
    {
      title: 'Full-Stack Banking Microservices Platform',
      desc: 'Architected an enterprise Spring Boot microservice backend with Spring Security JWT and a modern React frontend dashboard.',
      tags: ['Spring Boot', 'React.js', 'JWT', 'Microservices']
    },
    {
      title: 'E-Commerce Marketplace with Spring Data JPA & MySQL',
      desc: 'Developed a full-stack online shopping platform with cart management, order processing, Hibernate ORM, and MySQL database.',
      tags: ['Spring Boot 3', 'Hibernate', 'React', 'MySQL']
    },
    {
      title: 'Healthcare Patient Portal Dockerized on AWS',
      desc: 'Built containerized Spring Boot APIs and React SPA, deploying containers on AWS EC2 with RDS database hosting.',
      tags: ['Docker', 'AWS EC2', 'AWS RDS', 'Spring Boot']
    }
  ];
      ...
      <section className="relative text-white py-16 md:py-24 overflow-hidden border-b border-slate-800 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="flex items-center gap-2 text-xs text-slate-400 mb-6">
            ...
            <i className="fas fa-chevron-right text-[10px]"></i>
            <span className="text-slate-200">Java Full Stack Training {location ? `in ${location.name}` : ''}</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-xs font-semibold mb-5">
                <i className="fab fa-java"></i> Ranked #1 Java Full Stack Institute in {locName}
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-tight mb-4">
                Advanced Certification in <span className="bg-gradient-to-r from-orange-400 via-amber-300 to-yellow-200 bg-clip-text text-transparent">Java Full Stack Engineering</span> {location ? <span className="text-white block mt-1 text-2xl md:text-3xl font-extrabold">in {location.name}</span> : null}
              </h1>

              <p className="text-slate-300 text-base md:text-lg mb-6 leading-relaxed">
                Master Core Java, Spring Boot 3, Microservices Architecture, Hibernate, React.js, MySQL, and AWS Cloud Deployment in {locName} with 100% Placement Assistance.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-8 text-sm">
                <div className="flex items-center gap-1.5 bg-slate-800/80 border border-slate-700 px-3.5 py-2 rounded-xl text-amber-400 font-bold">
                  ...
                  <span>4.9 / 5</span>
                  <span className="text-slate-400 font-normal text-xs ml-1">(3,500+ Reviews)</span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() => openEnrollModal('Java Full Stack Master Program')}
                ...
                <button
                  onClick={() => openEnrollModal('Java Full Stack Master Program - Syllabus')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="p-4 border-r border-slate-100 last:border-0">
              <p className="text-3xl md:text-4xl font-black text-orange-600 mb-1">17,100+</p>
              <p className="text-xs md:text-sm text-slate-600 font-semibold uppercase tracking-wide">Java Full Stack Students</p>
            </div>
            <div className="p-4 border-r border-slate-100 last:border-0">
              <p className="text-3xl md:text-4xl font-black text-amber-600 mb-1">9,800+</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900">
              Java Full Stack Frameworks & Tools You Will Master
            </h2>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {javaFullstackTools.map((tool, idx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <h2 className="text-3xl md:text-4xl font-black tracking-tight leading-tight mb-4">
                Earn ISO 9001:2015 Certified Java Full Stack Engineer Certification
              </h2>
              <p className="text-slate-300 text-base leading-relaxed mb-6">
                Receive an official, lifetime-valid LearnMore Technologies Java Full Stack Engineer Certificate accredited by international quality standards.
              </p>
              <button
                onClick={() => openEnrollModal('Java Full Stack Certification Sample')}
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="bg-slate-800 border-2 border-orange-400/50 rounded-3xl p-8 text-center shadow-2xl max-w-md w-full relative overflow-hidden">
                ...
                <p className="text-xs text-orange-300 font-extrabold uppercase tracking-widest mb-4">Java Full Stack Engineer Certified</p>
                <div className="pt-4 border-t border-slate-700 text-[11px] text-slate-400 font-mono">
                  VERIFIED CERTIFICATE ID: LMT-JAVA-FS-2026
                </div>
              </div>
            </div>
          </div>
              ...
              <tbody className="divide-y divide-slate-800/80 text-sm bg-slate-950/60">
                <tr className="hover:bg-slate-900/50 transition">
                  ...
                  <td className="py-5 px-6 bg-orange-950/20 border-l border-r border-orange-500/30 text-emerald-400 font-semibold">
                    <i className="fas fa-check-circle mr-2 text-emerald-400"></i> Lead Java Full Stack Architects with 14+ Yrs MNC Experience
                  </td>
                ...
                <tr className="hover:bg-slate-900/50 transition">
                  ...
                  <td className="py-5 px-6 bg-orange-950/20 border-l border-r border-orange-500/30 text-emerald-400 font-semibold">
                    <i className="fas fa-check-circle mr-2 text-emerald-400"></i> 100% Practical React, Spring Boot 3 & Microservices Labs
                  </td>
                  <td className="py-5 px-6 text-slate-400">
                ...
                <tr className="hover:bg-slate-900/50 transition">
                  ...
                  <td className="py-5 px-6 bg-orange-950/20 border-l border-r border-orange-500/30 text-emerald-400 font-semibold">
                    <i className="fas fa-check-circle mr-2 text-emerald-400"></i> 3 End-to-End Enterprise Full-Stack Microservice Projects
                  </td>
                  <td className="py-5 px-6 text-slate-400">
